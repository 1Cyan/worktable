 ...
 * For the openmp edition, when processing zoomed simulations, enabling this flag assumes high-reoslution **DM particles have the same mass recorded in the gadget snapshot header. If this is not the case, do not enable this flag**. 
